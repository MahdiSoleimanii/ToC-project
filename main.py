...
testfa16 = DFA(testcases[15]['states'], testcases[15]['alphabet'], testcases[15]['start_state'], testcases[15]['accepting_states'], testcases[15]['transition_function'])

print(testfa15.minimize() == testfa16)